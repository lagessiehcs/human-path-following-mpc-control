classdef Visualizer < matlab.System & matlab.system.mixin.CustomIcon
    % VISUALIZER 2D Robot Visualizer
    %
    ...
    properties(Access = private)
        ...
        CurrWaypointHandle; % Handle to current waypoints
    ...
    methods(Access = protected)
        ...
        function setupImpl(obj)
            ...
            if obj.hasWaypoints
                ...
                obj.CurrWaypointHandle = plot(obj.ax,0,0, ...
        ...
        function stepImpl(obj,pose,varargin)          
            ...
            if obj.hasWaypoints && numel(waypoints) > 1
                set(obj.WaypointHandle,'xdata',waypoints(:,1), ...
                                       'ydata',waypoints(:,2));
                set(obj.CurrWaypointHandle,'xdata',waypoints(end,1), ...
                                           'ydata',waypoints(end,2));
            end
